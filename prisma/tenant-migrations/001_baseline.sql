-- 001 — Tenant şemasının temel hâli (baseline).
--
-- Bu dosya `prisma migrate diff` çıktısından üretildi ve ELLE
-- DÜZENLENMEZ. Uygulandıktan sonra değiştirilirse runner checksum
-- uyuşmazlığı verir; şema değişikliği için YENİ migration yazılır.
