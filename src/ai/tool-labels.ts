...
const LABELS: Readonly<Record<string, string>> = {
  ...
  project_cash_flow: "Nakit akışı çıkarıldı",
  get_cash_flow_statement: "Nakit akış tablosu çıkarıldı",
  create_cost_center: "Masraf merkezi açıldı",
  get_credit_exposure: "Kredi riski okundu",
  create_inspection_plan: "Kontrol planı açıldı",
  create_purchase_contract: "Çerçeve sözleşme açıldı",
  create_routing: "Rota tanımlandı",
  create_operation_plan: "İşlem planı hazırlandı",
  get_operation_plan: "İşlem planı okundu",
  list_operation_plans: "İşlem planları okundu",
  run_operation_plan: "İşlem planı çalıştırıldı",
  cancel_operation_plan: "İşlem planı iptal edildi",
  search_conversations: "Geçmiş konuşmalar arandı",
  get_past_conversation: "Geçmiş konuşma okundu",
  get_routing_load: "Rota yükü hesaplandı",
  set_standard_cost: "Standart maliyet girildi",
  get_cost_variance: "Maliyet sapması çıkarıldı",
  create_storage_bin: "Raf açıldı",
  get_bin_contents: "Raf içeriği okundu",
  list_purchase_contracts: "Sözleşmeler okundu",
  release_from_contract: "Sözleşmeden sipariş çekildi",
  get_supplier_scorecard: "Tedarikçi karnesi çıkarıldı",
  get_price_history: "Fiyat geçmişi okundu",
  get_inspection_plan: "Kontrol planı okundu",
  record_inspection_result: "Muayene kaydedildi",
  list_open_nonconformances: "Açık uygunsuzluklar okundu",
  close_nonconformance: "Uygunsuzluk kapatıldı",
  build_certificate_of_analysis: "Analiz sertifikası hazırlandı",
  set_credit_limit: "Kredi limiti tanımlandı",
  check_availability: "Teslim tarihi hesaplandı",
  list_cost_centers: "Masraf merkezleri okundu",
  set_budget: "Bütçe girildi",
  get_budget_vs_actual: "Bütçe–gerçekleşme çıkarıldı",
  import_bank_statement: "Banka ekstresi alındı",
  list_unreconciled: "Eşleşmemiş hareketler okundu",
  suggest_reconciliation: "Eşleştirme adayları arandı",
  post_reconciliation: "Mutabakat kaydedildi",
  plan_dunning_run: "İhtar planı hazırlandı",
  issue_dunning_notice: "İhtar kaydedildi",
  plan_payment_run: "Ödeme planı hazırlandı",
  set_payable_due_date: "Fatura vadesi yazıldı",
...
export const ACTION_LABELS: Readonly<Record<string, string>> = {
  ...
  project_cash_flow: "Nakit akışını çıkar",
  get_cash_flow_statement: "Nakit akış tablosunu çıkar",
  create_cost_center: "Masraf merkezi aç",
  get_credit_exposure: "Kredi riskini oku",
  create_inspection_plan: "Kontrol planı aç",
  create_purchase_contract: "Çerçeve sözleşme aç",
  create_routing: "Rota tanımla",
  create_operation_plan: "İşlem planı hazırla",
  get_operation_plan: "İşlem planını oku",
  list_operation_plans: "İşlem planlarını listele",
  run_operation_plan: "İşlem planını çalıştır",
  cancel_operation_plan: "İşlem planını iptal et",
  search_conversations: "Geçmiş konuşmalarda ara",
  get_past_conversation: "Geçmiş konuşmayı oku",
  get_routing_load: "Rota yükünü hesapla",
  set_standard_cost: "Standart maliyet gir",
  get_cost_variance: "Maliyet sapmasını çıkar",
  create_storage_bin: "Raf aç",
  get_bin_contents: "Raf içeriğini oku",
  list_purchase_contracts: "Sözleşmeleri listele",
  release_from_contract: "Sözleşmeden sipariş çek",
  get_supplier_scorecard: "Tedarikçi karnesi çıkar",
  get_price_history: "Fiyat geçmişini oku",
  get_inspection_plan: "Kontrol planını oku",
  record_inspection_result: "Muayene sonucunu kaydet",
  list_open_nonconformances: "Açık uygunsuzlukları listele",
  close_nonconformance: "Uygunsuzluğu kapat",
  build_certificate_of_analysis: "Analiz sertifikası hazırla",
  set_credit_limit: "Kredi limiti tanımla",
  check_availability: "Teslim tarihini hesapla",
  list_cost_centers: "Masraf merkezlerini listele",
  set_budget: "Bütçe gir",
  get_budget_vs_actual: "Bütçe–gerçekleşmeyi çıkar",
  import_bank_statement: "Banka ekstresini al",
  list_unreconciled: "Eşleşmemiş hareketleri listele",
  suggest_reconciliation: "Eşleştirme adayı ara",
  post_reconciliation: "Mutabakatı kaydet",
  plan_dunning_run: "İhtar planı hazırla",
  issue_dunning_notice: "İhtarı kaydet",
  plan_payment_run: "Ödeme planı hazırla",
  set_payable_due_date: "Fatura vadesini yaz",
